...
The module that contains utility functions related to facebook training and evaluation
"""
import time
import logging
...
def train_epoch(
    ...
    """
    Train the facebook for an epoch
    """
...
def eval_epoch(
    ...
    """
    Evaluate the facebook for an epoch
    """
...
def train(
    ...
    **kwargs
    ...
    """
    Train the facebook and evaluate for entire epochs with given train and valid dataloader.
    """
    check_kwargs(
...
def eval_model(
    ...
    **kwargs
    ...
    """
    Evaluate the facebook with test dataloader.
...
def get_base_embedding(
    ...
    """
    Get embedding of given base facebook and train dataloader.
    """
