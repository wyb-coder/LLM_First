...
if __name__ == '__main__':
    ...
    parser.add_argument('--facebook', type=str, default='facebook/bart-large',
                        help="Model config to use to load the facebook class.")
    ...
    model.load_state_dict(torch.load(args.checkpoint, map_location='cpu')['facebook'])
    model.to(device)
