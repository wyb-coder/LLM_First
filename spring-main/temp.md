...
sample_csv.py
python bin/sample_csv.py --csv result/train.sent.txt.csv
python bin/sample_csv.py --csv outputs/train_amr_triples.csv
python bin/sample_csv.py --csv outputs/train_with_triples.csv
